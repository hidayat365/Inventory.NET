    ...
    public partial class frmItemList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daItems1.FillDenormalized(dsCore1.Items);
            }
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        this.BindingContext[this.dsCore1, "Items"].RemoveAt(this.BindingContext[this.dsCore1, "Items"].Position);
                        this.daItems1.Update(this.dsCore1.Items);
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadItemList());
