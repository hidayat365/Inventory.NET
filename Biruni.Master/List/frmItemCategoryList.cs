...
{
    public partial class frmItemCategoryList : Biruni.Shared.Templates.frmList
    {
        public frmItemCategoryList()
        {
            InitializeComponent();
            InitializeData();
        }
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daItemCategories1.Fill(dsCore1.ItemCategories);
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmItemCategoryEntry();
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmItemCategoryEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        this.BindingContext[this.dsCore1, "ItemCategories"].RemoveAt(this.BindingContext[this.dsCore1, "ItemCategories"].Position);
                        this.daItemCategories1.Update(this.dsCore1.ItemCategories);
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadItemCategoryList());
