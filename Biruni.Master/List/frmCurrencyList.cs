...
{
    public partial class frmCurrencyList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daCurrencies1.Fill(dsCore1.Currencies);
            }
            catch (Exception ex)
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmCurrencyEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        this.BindingContext[this.dsCore1, "Currencies"].RemoveAt(this.BindingContext[this.dsCore1, "Currencies"].Position);
                        this.daCurrencies1.Update(this.dsCore1.Currencies);
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadCurrencyList());
