...
{
    public partial class frmCompanyBalanceList : Biruni.Shared.Templates.frmList
    {
        CompanyTypes type;

        public frmCompanyBalanceList(CompanyTypes type)
        {
            InitializeComponent();
            InitializeForm(type);
            InitializeData(type);
        ...
        private void InitializeForm(CompanyTypes type)
        {
            ...
            if (type == CompanyTypes.Customer)
            {
                this.Text = "Customer Opening Balance List";
                this._grid.Caption = "Customer Opening Balance List";
            }
            else
            {
                this.Text = "Vendor Opening Balance List";
                this._grid.Caption = "Vendor Opening Balance List";
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmCompanyBalanceEntry(type);
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmCompanyBalanceEntry(type, (int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        this.daOrders1.Update(this.dsCore1.Orders);
