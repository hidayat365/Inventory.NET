...
{
    public partial class frmUnitMeasureList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daUnitMeasures1.Fill(dsCore1.UnitMeasures);
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmUnitMeasureEntry();
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmUnitMeasureEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        this.BindingContext[this.dsCore1, "UnitMeasures"].RemoveAt(this.BindingContext[this.dsCore1, "UnitMeasures"].Position);
                        this.daUnitMeasures1.Update(this.dsCore1.UnitMeasures);
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadUnitMeasureList());
