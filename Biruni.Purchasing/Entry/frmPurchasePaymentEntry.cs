...
using Biruni.Purchasing.Search;

namespace Biruni.Purchasing.Entry
{
    public partial class frmPurchasePaymentEntry : Biruni.Shared.Templates.frmEntry2
    {
        public frmPurchasePaymentEntry()
        {
            frmPurchasePaymentEntry_Helper(-1);
        }
        public frmPurchasePaymentEntry(int id)
        {
            frmPurchasePaymentEntry_Helper(id);
        }

        public void frmPurchasePaymentEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeData(int id)
        {
            ...
            try
            {
                ...
                daOrders1.FillPurchaseInvoiceAll(dsCore2.Orders);
                // get data
                if (id < 0)
                {
                    // mode
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_PURCHASE_PAYMENT;
            // grid event handlers
        ...
        void _grid_BeforeAddRow(object sender, RowColEventArgs e)
        {
            ...
            {
                RibbonMessageBox.Show("Please select Vendor and set currency type before adding payment details",
                    Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Cancel = true;
            }
        ...
        private void _grid_CellButtonClick(object sender, RowColEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    frmPurchaseInvoiceSearch fx = new frmPurchaseInvoiceSearch((int)c1Combo1.SelectedValue);
                    fx.ShowDialog();
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadPurchasePaymentForm(c1TextBox1.Text));
