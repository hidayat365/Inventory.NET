...
{
    public partial class frmInventoryAdjustmentEntry : Biruni.Shared.Templates.frmEntry2
    {
        public frmInventoryAdjustmentEntry()
        {
            frmInventoryAdjustmentEntry_Helper(-1);
        }

        public frmInventoryAdjustmentEntry(int id)
        {
            frmInventoryAdjustmentEntry_Helper(id);
        }

        public void frmInventoryAdjustmentEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_INVENTORY_ADJUSTMENT;
            // grid event handlers
            ...
            try
            {
                ...
                _grid.Cols["UnitPrice"].Visible = false;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txMode == DataEntryModes.Add)
                {
                    ...
                    {
                        Cursor = Cursors.AppStarting;
                        Form fx = new frmReportViewer1(ReportHelper1.LoadInventoryAdjustmentForm(c1TextBox1.Text));
