...
{
    public partial class frmDeliveryOrderEntry : Biruni.Shared.Templates.frmEntry2
    {
        public frmDeliveryOrderEntry()
        {
            frmDeliveryOrderEntry_Helper(-1);
        }

        public frmDeliveryOrderEntry(int id)
        {
            frmDeliveryOrderEntry_Helper(id);
        }

        public void frmDeliveryOrderEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_DELIVERY_ORDER;
            // grid event handlers
