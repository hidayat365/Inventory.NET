...
{
    public partial class frmReceivingReportEntry : Biruni.Shared.Templates.frmEntry2
    {
        public frmReceivingReportEntry()
        {
            frmReceivingReportEntry_Helper(-1);
        }

        public frmReceivingReportEntry(int id)
        {
            frmReceivingReportEntry_Helper(id);
        }

        public void frmReceivingReportEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeData(int id)
        {
            ...
            try
            {
                ...
                daOrders1.FillPurchaseBackOrders(dsCore2.Orders);
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_RECEIVING_REPORT;
            // grid event handlers
            ...
            try
            {
                ...
                _grid.Cols["Quantity"].AllowEditing = true;
                _grid.Cols["UnitPrice"].AllowEditing = false;
                _grid.Cols["TaxPct"].AllowEditing = false;
                // hide columns
                ...
                _grid.Cols["Quantity"].Visible = true;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txMode == DataEntryModes.Add)
                {
                    ...
                    {
                        Cursor = Cursors.AppStarting;
                        Form fx = new frmReportViewer1(ReportHelper1.LoadReceivingReportForm(c1TextBox1.Text));
