    ...
    public partial class frmReceivingReportList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daOrders1.FillReceivingReports(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1).AddSeconds(-1));
            }
            catch (Exception ex)
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmReceivingReportEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            daOrders1.FillReceivingReports(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1));
            _grid.Bookmark = pos;
            Cursor = Cursors.Default;
        }
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadReceivingReportList((DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1)));
