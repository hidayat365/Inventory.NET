...
{
    public partial class frmDeliveryOrderList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daOrders1.FillDeliveryOrders(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1));
            }
            catch (Exception ex)
            {
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadDeliveryOrderList((DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1)));
