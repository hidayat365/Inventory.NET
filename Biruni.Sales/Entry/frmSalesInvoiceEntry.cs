...
{
    public partial class frmSalesInvoiceEntry : Biruni.Shared.Templates.frmEntry2
    {
        public frmSalesInvoiceEntry()
        {
            frmSalesInvoiceEntry_Helper(-1);
        }
        public frmSalesInvoiceEntry(int id)
        {
            frmSalesInvoiceEntry_Helper(id);
        }

        public void frmSalesInvoiceEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeData(int id)
        {
            ...
            try
            {
                ...
                daOrders1.FillSalesOrdersAll(dsCore2.Orders);
                // get data
                if (id < 0)
                {
                    // mode
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_SALES_INVOICE;
            // grid event handlers
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadSalesInvoiceForm(c1TextBox1.Text));
