...
namespace Biruni.Sales.Entry
{
    public partial class frmSalesQuotationEntry : Biruni.Shared.Templates.frmEntry2
    {
        ...
        {
            frmSalesQuotationEntry_Helper(-1);
        }

        public frmSalesQuotationEntry(int id)
        {
            frmSalesQuotationEntry_Helper(id);
        }

        public void frmSalesQuotationEntry_Helper(int id)
        {
            InitializeComponent();
            InitializeForm();
            InitializeData(id);
        ...
        private void InitializeForm()
        {
            ...
            // transaction type
            ModulePrefix = TransactionTypes.TX_SALES_QUOTATION;
            // grid event handlers
            ...
            {
                Logger.ErrorRoutine(ex);
                RibbonMessageBox.Show("ERROR Initializing Form: " + ex.Message,
                    Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
