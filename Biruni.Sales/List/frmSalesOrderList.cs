...
{
    public partial class frmSalesOrderList : Biruni.Shared.Templates.frmList
    {
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daOrders1.FillSalesOrders(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1));
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmSalesOrderEntry();
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmSalesOrderEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadSalesOrderList((DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1)));
