...
using Biruni.Sales.Entry;

namespace Biruni.Sales.List
{
    public partial class frmSalesQuotationList : Biruni.Shared.Templates.frmList
    {
        public frmSalesQuotationList()
        {
            InitializeComponent();
            InitializeData();
        }
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daOrders1.FillSalesQuotation(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1));
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmSalesQuotationEntry();
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmSalesQuotationEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadSalesQuotationList((DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1)));
