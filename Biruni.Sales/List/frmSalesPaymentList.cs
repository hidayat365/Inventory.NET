...
{
    public partial class frmSalesPaymentList : Biruni.Shared.Templates.frmList
    {
        public frmSalesPaymentList()
        {
            InitializeComponent();
            InitializeData();
        }
        ...
        private void InitializeData()
        {
            try
            {
                ...
                daOrders1.FillSalesPayment(dsCore1.Orders, (DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1));
            }
            catch (Exception ex)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Form fx = new frmSalesPaymentEntry();
            fx.ShowDialog();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Form fx = new frmSalesPaymentEntry((int)_grid.Columns["id"].Value);
                fx.ShowDialog();
                btnRefresh.PerformClick();
            }
            catch
        ...
        {
            Cursor = Cursors.AppStarting;
            Form fx = new frmReportViewer1(ReportHelper1.LoadSalesPaymentList((DateTime)dtpBegin.Value, ((DateTime)dtpEnd.Value).AddDays(1)));
